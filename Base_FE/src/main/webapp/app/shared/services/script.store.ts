...
export const ScriptStore: Scripts[] = [
  { name: 'bootstrap.min.js', src: 'assets/plugins/bootstrap/js/bootstrap.min.js' },
  { name: 'ckeditor.js', src: 'assets/plugins/ckeditor.js' },
  { name: 'demo.js', src: 'assets/js/demo.js' },
  { name: 'jquery-1.11.1.min.js', src: 'assets/plugins/jquery/jquery-1.11.1.min.js' },
  { name: 'jquery-ui.min.js', src: 'assets/plugins/jquery-ui/jquery-ui.min.js' },
  { name: 'jquery.scrollbar.min.js', src: 'assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js' },
