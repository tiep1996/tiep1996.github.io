...
import {CredentialsInterceptor} from "app/blocks/interceptor/credentials.interceptor";
import {CsrfInterceptor} from "app/blocks/interceptor/csrf.interceptor";
import {AuthTokenInterceptor} from "app/blocks/interceptor/auth-token.interceptor";
@NgModule({
  imports: [
    HttpClientModule,
